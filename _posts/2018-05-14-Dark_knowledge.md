...
3. I followed all the tricks mentioned in the paper to get the same exact numbers mentioned in the [paper]((https://arxiv.org/abs/1503.02531)). You can find the details of my work [here](??github)
...
## Results
1. The ensemble network gives $$94$$ mis-classification error.
2. The small network with hard-update (using the labels) gives $$165$$ mis-classification error.
3. The distilled network is giving $$193$$ misclassification problem. 
